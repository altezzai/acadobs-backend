...
router.get("/getExams", staffController.getExams);
...
router.get("/getStaffSubjects", staffController.getStaffSubjects);

router.get("/getMyPermissions", staffController.getMyPermissions);
